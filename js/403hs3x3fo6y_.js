  ...
  (e, t, r) => {
    ...
    function m(t) {
      ...
      let o,
        u,
        m,
        [v, P] = (0, a.useOptimistic)(h.IDLE_LINK_STATUS),
        _ = (0, a.useRef)(null),
        {
          href: O,
          as: E,
      ...
      let B = a.default.useContext(c.AppRouterContext),
        ...
        D =
          !1 !== S
            ...
            : g.FetchStrategy.PPR,
        K = "string" == typeof (r = E || O) ? r : (0, l.formatUrl)(r);
      if (M) {
      ...
      let z = M ? u && "object" == typeof u && u.ref : $,
        Q = a.default.useCallback(
          (e) => (
            null !== B &&
              (_.current = (0, h.mountLinkInstance)(e, K, B, D, F, P)),
            () => {
              (_.current &&
        ...
        W = {
          ref: (0, s.useMergedRef)(Q, z),
          onClick(t) {
            (M || "function" != typeof L || L(t),
              M &&
                u.props &&
          ...
          onMouseEnter(e) {
            (M || "function" != typeof w || w(e),
              ...
              B && F && (0, h.onNavigationIntent)(e.currentTarget, !0 === I));
          },
      ...
      return (
        (0, f.isAbsoluteUrl)(K)
          ? (W.href = K)
          : (M && !T && ("a" !== u.type || "href" in u.props)) ||
            (W.href = (0, p.addBasePath)(K)),
        (m = M
          ? a.default.cloneElement(u, W)
          : (0, i.jsx)("a", { ...k, ...W, children: o })),
        (0, i.jsx)(b.Provider, { value: v, children: m })
      );
    }
    e.r(84508);
